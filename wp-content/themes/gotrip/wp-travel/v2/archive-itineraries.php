...
<body <?php body_class(); ?>>
	<?php wp_body_open(); ?>
		<div class="wp-site-blocks">
			...
			<?php echo $block_main; ?>
<!-- 			<main class="wp-block-group trip-archive-page is-layout-constrained wp-block-group-is-layout-constrained" style="padding-right:var(--wp--preset--spacing--30);padding-left:var(--wp--preset--spacing--30)" id="wp--skip-link--target"> -->
