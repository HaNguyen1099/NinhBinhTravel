        ...
        <div class="gotrip-admin-card-header">
            ...
            <div class="gotrip-header-right">
                <div class="gotrip-card-header-button-group">
                    <a href="<?php echo esc_url( $live_demo_url ); ?>" class="gotrip-admin-button premium-button" target="_blank"
        ...
        <div class="feature-list">
                ...
                <div class="gotrip-admin-card features">
                    <div class="gotrip-about-container gotrip-compare-table">
                        <div class="admin-grid-1">
                            ...
                            <p class="gotrip-compare-table-subtitle"><a href="<?php echo esc_url( $pro_purchase_url ); ?>"
                                    target="__blank">
            ...
            <div class="gotrip-about-side">
                <div class="gotrip-admin-card cart-two">
                    ...
                    </p><a href="<?php echo esc_url( $support_url ); ?>" class="gotrip-admin-button primary large"
                        target="_blank">
                        <?php esc_html_e( 'Get Support', 'gotrip' ); ?>
                    </a>
                    <a href="<?php echo esc_url( $pro_purchase_url ); ?>" class="gotrip-admin-button primary large"
                        target="_blank">
