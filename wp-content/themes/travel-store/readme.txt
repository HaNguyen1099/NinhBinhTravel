...
Travel Store WordPress Theme, Copyright 2023 Eagle Themes
Travel Store is distributed under the terms of the GNU GPL
...
Brand Images are self illustrated images which includes in screenshot
...
* Footer card
https://pxhere.com/en/photo/1448011

Barlow:
Author: Jeremy Tribby, Cadson Demak
...
Wow.js - Copyright (c) 2014-2015 Matthieu Aussaguel
License: MIT License
...
= 1.0.2 =
* Added Theme Info Page On Admin Dashboard
* Added Theme Notification

= 1.0.3 =
* Added  Different Color Variation
* Minor Design Fixes

= 1.0.4 =
* Added Latest Post Section
* Removed Index.php file
* Fixed Tags not displaying issue
